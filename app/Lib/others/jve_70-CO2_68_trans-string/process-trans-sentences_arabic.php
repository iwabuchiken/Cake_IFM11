...
echo =============================== >> log_process-trans-sentences_arabic.log && php process-trans-sentences_arabic.php >> log_process-trans-sentences_arabic.log && echo. >> log_process-trans-sentences_arabic.log

php process-trans-sentences_arabic.php

// echo =============================== >> log_process-trans-sentences_arabic.log && php process-trans-sentences_arabic.php >> log_process-trans-sentences_arabic.log && time >>  log_process-trans-sentences_arabic.log && echo. >> log_process-trans-sentences_arabic.log
...
// 				, $msg, __FILE__, __LINE__);
	...
	function build_Trans_String() {
		...
		********************/
		...
		#debug
		$message	= "\$linesOf_File__Trimmed =>";
		$message	.= "\n";
		$message	.= "\n";
		
		printf("[%s : %d] %s", basename(__FILE__), __LINE__, $message);
		
		print_r($linesOf_File__Trimmed);
...
// 		$stringOf_Joined_Lines	= join(" ", $linesOf_File);
		...
		$pattern	= "/^.+\[.+/i";	#=> pattern-id:20210618_102214 // 
...
// 				print ("\n");
		...
		#debug
		$message	= "\$aryOf_Tokens__Filtered_In =>";
		$message	.= "\n";
		$message	.= "\n";
